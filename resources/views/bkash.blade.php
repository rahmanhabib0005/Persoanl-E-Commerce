          ...
          <div class="row d-flex justify-content-center align-item-center">
               <div class="col-md-8 col-lg-7 col-sm-12">
                    ...
                    <div class="card border-white">
                         <img src="assests/images/payment.webp" alt="payment">
                    </div>
               </div>
               <div class=" col-md-5 col-lg-6 col-sm-12">
                    <form method="post" action='/login'>
                         @csrf
                         <div class="mb-3">
                         <label for="name" class="form-label text-dark">Enter Your Bkash Number</label>
                         ...
                         <button type="disable" class="btn btn-primary">Payment Now</button>
                       </form>
               </div>
          </div>
     </div>
